...
export function GameSetupPage() {
  ...
  if (teams.length === 0) {
    return (
      <Layout title="New Game" showBack onBack={handleCancel}>
      ...
      <div className="flex flex-col gap-6 p-4">
        ...
        <div>
          ...
          <input
            ...
            className="w-full min-h-[44px] px-4 py-2 bg-white border border-gray-300 rounded-lg text-base text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
          />
        </div>
